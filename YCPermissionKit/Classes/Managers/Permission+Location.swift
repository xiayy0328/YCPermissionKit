...
extension PermissionProvider {
    ...
    public static func location(_ type: LocationType) -> PermissionProvider {
...
struct LocationManager: Permissionable {
    ...
    private let type: PermissionProvider.LocationType
    
    init(_ type: PermissionProvider.LocationType) {
        self.type = type
    }
...
class LocationDelegate: NSObject, CLLocationManagerDelegate {
    ...
    let type: PermissionProvider.LocationType
    let сompletion: () -> Void
    
    init(_ type: PermissionProvider.LocationType, _ сompletion: @escaping () -> Void) {
        self.type = type
